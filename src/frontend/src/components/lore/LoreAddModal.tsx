...
import { X, Plus, Book, Calendar, Globe, Users, Scroll } from 'lucide-react';
...
interface LoreAddModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (loreEntry: Omit<LoreEntry, 'id'>) => void;
}
...
export const LoreAddModal: React.FC<LoreAddModalProps> = ({
  isOpen,
  onClose,
  onAdd,
}) => {
  ...
  return (
    <ModalOverlay $isOpen={isOpen} onClick={handleClose}>
      <ModalContent onClick={(e) => e.stopPropagation()}>
        <ModalHeader>
          <ModalTitle>Add New Lore Entry</ModalTitle>
