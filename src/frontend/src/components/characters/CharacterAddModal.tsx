...
import { X, Plus, User, Globe, Users, Scroll } from 'lucide-react';
...
export const CharacterAddModal: React.FC<CharacterAddModalProps> = ({
  isOpen,
  onClose,
  onAdd,
}) => {
  const { trackCharacterCreation, trackFeatureUsage } = useAnalytics();
  ...
  const handleAdd = () => {
    if (validateForm()) {
      // Track character creation start
      trackFeatureUsage('character-creation', 'create-character', true);
      
      // Track character creation with specific details
      trackCharacterCreation(formData.affiliation, 'original_trilogy', true);
  ...
  return (
    <ModalOverlay $isOpen={isOpen} onClick={handleClose}>
      <ModalContent onClick={(e) => e.stopPropagation()}>
        <ModalHeader>
          <ModalTitle>Add New Character</ModalTitle>
